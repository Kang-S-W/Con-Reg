...
if st.session_state.current_page == "main":
    ...
    st.caption("용인시 조례와 관련 법령을 함께 검토해 주요 기준, 예외 조건, 행정 검토 포인트를 정리합니다. 취급 법규의 범위는 사이트맵을 통해 확인 바랍니다. PDF로 범위 외 법규를 추가하여 분석하실 수 있으며, 각 법규의 [별표]는 기본 데이터로 저장되어 있지 않습니다. ")
    st.write("")
