            ...
            if current_chat is not None:
                ...
                st.markdown(
                    ...
                    <div class="app-intro">
                        ...
                        <p>상위 법령, 경기도 조례, 용인시 조례를 함께 검토해 실무 검토에 필요한 기준을 정리합니다. 취급 법규의 범위는 사이트맵을 통해 확인 바랍니다. PDF로 범위 외 법규를 추가하여 분석하실 수 있으며, 각 법규의 [별표]는 기본 데이터로 저장되어 있지 않습니다. 마지막 법규 업데이트 기준일은 2026.04.03이며, 개정된 법규목록은 우측 하단에서 확인하실 수 있습니다. 5개의 대화 내역이 이후 답변 맥락으로 반영됩니다.</p>
                    </div>
                    """,
                    unsafe_allow_html=True,
                )
